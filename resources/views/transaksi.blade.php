    ...
    <div class="row">
        ...
        <div class="col-md-3 sidebar">
            ...
            <div class="cart-items mt-4">
                ...
                <ul id="cart-items-list" class="list-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="received_amount" name="received_amount" placeholder="Masukan Uang" >
                    </div>
                </ul>
            </div>
            ...
            <div class="summary mt-4">
                ...
                <p class="total-amount">Total Amount: Rp. <span id="total-amount">{{ number_format($sale->total_harga, 0, ',', '.') }}</span></p>
